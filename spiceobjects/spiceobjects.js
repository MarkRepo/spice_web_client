...
wdi.SpiceH264FrameCreate = $.spcExtend(wdi.SpiceObject, {
    ...
    demarshall: function(queue, expSize){
        ...
        this.width = this.bytesToInt32NoAllocate(queue);
        this.height = this.bytesToInt32NoAllocate(queue);
        this.codec = this.bytesToInt32NoAllocate(queue);
        this.flags = this. bytesToInt32NoAllocate(queue);
        return this;
    }
});

wdi.SpiceH264FrameData = $.spcExtend(wdi.SpiceObject, {
    objectSize: 12,
...
wdi.SpiceH264FrameDestroy = $.spcExtend(wdi.SpiceObject, {
    ...
    marshall: function(){
        this.rawData = [];
        this.rawData = this.rawData.concat(this.numberTo32(this.id));
    },
...
wdi.PlaybackVolume = $.spcExtend(wdi.SpiceObject, {
    objectSize: 4,
    ...
    demarshall: function(queue, expSize){
        ...
        this.nchannels = this.bytesToInt8NoAllocate(queue);
        var i;
        this.volumes = new Array(this.nchannels);
        for(i = 0; i< this.nchannels; i++){
            this.volumes[i] = this.bytesToInt16NoAllocate(queue);
        }
...
wdi.PlaybackMute = $.spcExtend(wdi.SpiceObject, {
    objectSize: 1,
    ...
    demarshall: function(queue, expSize){
        ...
        this.mute = this.bytesToInt8NoAllocate(queue);
        return this;
    }
});
